...
namespace P2PDelivery.Infrastructure.Migrations
{
    ...
    [Migration("20250410001152_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("P2PDelivery.Domain.Entities.Application", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("P2PDelivery.Domain.Entities.Chat", b =>
                {
                    b.HasOne("P2PDelivery.Domain.Entities.DeliveryRequest", "DeliveryRequest")
                        .WithOne("Chat")
                        .HasForeignKey("P2PDelivery.Domain.Entities.Chat", "DeliveryRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("P2PDelivery.Domain.Entities.ChatMessage", b =>
                {
                    ...
                    b.HasOne("P2PDelivery.Domain.Entities.User", "Sender")
                        .WithOne()
                        .HasForeignKey("P2PDelivery.Domain.Entities.ChatMessage", "SenderId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("P2PDelivery.Domain.Entities.Match", b =>
                {
                    b.HasOne("P2PDelivery.Domain.Entities.Application", "Application")
                        .WithMany()
